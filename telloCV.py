...
class TelloCV(object):
    ...
    def init_controls(self):
        ...
        self.controls = {
            ...
            'v': lambda speed: self.take_picture("v", speed),
            'b': lambda speed: self.take_picture("b", speed),
            'n': lambda speed: self.take_picture("n", speed),
            'm': lambda speed: self.take_picture("m", speed),
        }
    ...
    def take_picture(self, key, speed):
    ...
    def handle_flight_received(self, event, sender, data):
        ...
        path = '%s/Pictures/%s/tello-%s.jpeg' % (
            os.getenv('HOME'),
            self.key,
